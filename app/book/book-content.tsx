        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="prose prose-invert mb-8 space-y-4">
              ...
              <p className="text-base md:text-lg text-[#c2c8c2] leading-relaxed">
                Learn how to harness AI while maintaining the authentic, human-centered values that made street commerce legendary. This is not a theoretical exercise&mdash;it's a practical blueprint for survival, sustainability, and multi-generational success.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <Link href="/checkout">
                <button className="w-full bg-[#98da27] text-[#0a1410] font-semibold py-4 rounded-lg hover:bg-[#b2f746] transition duration-300 flex items-center justify-center gap-2">
                  ...
                  Get Your Copy — Starting at ₦7,500
                </button>
              </Link>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-[#424844]">
              ...
              <p className="text-xs text-[#8c928d]">&copy; {new Date().getFullYear()} The University of the Streets Legacy | All Rights Reserved</p>
            </div>
          </div>
        </div>
      </div>
